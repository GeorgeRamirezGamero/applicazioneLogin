...
public class UserServiceImpl implements UserService{
	...
	//In fase di registrazione di un nuovo usuario, se l user name già esiste allora mandiamo un eccezione USERNAME NN DISPNIBILE
	...
	//In fase di registrazione di un nuovo usuario, verifichiamo le password inserita con quella di conferma
	...
	//Metodo che viene chiamato per creare nuovo usuario
	@Override
	...
	//Questo metodo per aggiornare l'user che stiamo modificando 
	@Override
	public User updateUser(User fromUser) throws Exception {
		User toUser = getUserById(fromUser.getId()); //recupero l'user dal DB
		mapUser(fromUser, toUser); //chiamiamo questo metodo per il map, nel senso che lo recupero, e aggiorniamo i dati con quello passato in input
		return repository.save(toUser); //dopodichè salviamo l'user recuperato dal db e aggiornato con i dati passati in input
	}
	
	//metodo chiamato da updateUser
	/**
